...
if __name__ == "__main__":
    checkpoint_dir = "C:/Users/Siemens/Documents/TFE_Nick_Kuijpers/LoRa_GPL/GPL_LoRA/output/scifact/distilbert-base-uncased/checkpoints" 
    ...
    for filename in os.listdir(checkpoint_dir):
        ...
        if filename.isdigit():  # Assuming model checkpoints are named with numbers
            ...
            evaluate(
                ...
                output_dir="C:/Users/Siemens/Documents/TFE_Nick_Kuijpers/LoRa_GPL/GPL_LoRA/evaluation/scifact/distilbert-base-uncased",
